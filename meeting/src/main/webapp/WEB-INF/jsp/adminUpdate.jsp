...
<div style="margin-left: 100px;">
        ...
        <form  id="upload" method="post" action="${pageContext.request.contextPath }/meeting/updateSave" enctype="multipart/form-data">
           <table border="1" cellpadding="15" align="center" style="text-align: center;">
				...
				<tr>
				  <td>城市</td>
				  <td>
				  <input type="text" name="city" value="${room.city }" class="Required"  > 
				...
				<tr>
				  <td>类型</td>
				  <td>
				 <input type="text" name="type" value="${room.type }" class="Required" > 
				   <!--  <label name="type">${room.type }</label>-->
				  </td>
				</tr>
				<tr>
				  <td>预约时间</td>
				  <td> <input type="date" name="time" value="${room.time }" class="Required" >
				...
				<tr>
				  <td>房间价格(￥)</td>
				  <td>
				  <input type="text" name="money" value="${room.money }" class="Required" >
				...
				<tr>
				  <td>容纳人数(人)</td>
				  <td>
				 <input type="text" name="num" value="${room.num }" class="Required" > 
				...
				<tr>
				  <td>状态</td>
				  <td>
				 <input type="text" name="state" value="${room.state }" class="Required" > 
				  <!--   <label name="num">${room.num }</label>-->
				  </td>
				</tr>
				<tr>
				 ...
				 <input type="text" name="date" value="${room.date }" class="Required" > 
				  ...
				  <td>会议室描述</td>
				  <td><textarea style="font-size: 18px;"  rows="3" id="user-intro" name="info" 
