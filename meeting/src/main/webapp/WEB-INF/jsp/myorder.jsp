	...
	<!-- <div class="feature-focus" id="feature-focus"> -->
        ...
        <form  id="upload" method="post" action="${pageContext.request.contextPath }/meeting/insertOrder" enctype="multipart/form-data">
           ...
           <c:if test="${room.id!=null }">
            <tr> <td align="center">
          <a style="font-size: 18px;" href="${pageContext.request.contextPath }/meeting/index" >确定</a></td>
            <!--  <button style="height:30px;" onclick="window.history.go(-1)" >删除预约</button></td> -->
            <td><a style="font-size: 18px;" href="${pageContext.request.contextPath }/meeting/deleteMyRooms/${room.id }" onclick="return del()">删除预约</a></td>
            </tr> 
            </c:if>
    </table> 
