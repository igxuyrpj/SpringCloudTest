		...
		<span style="margin-left: 800px; font-size: 16px;">欢迎您:${name }</span>
			...
			<div class="search">
				<form action="#" method="post">
					<input type="text" class="txt" id="mainName" name="q"
						maxlength="64" autocomplete="off" value=""
						placeholder="搜商户名/城市/关键字"> <input type="submit"
						value="搜  索" class="submit">
	...
	<div class="nav clearfix isMain">
		<div class="nav-in container clearfix">
			...
			<ul class="menus">
				...
				<li class="w65"><a href="${pageContext.request.contextPath}/meeting/adminUser">用户管理</a></li>
				<li class="w65"><a
					href="${pageContext.request.contextPath}/meeting/adminRoom">会议室<i class="hotNews"></i></a></li>
						
				<li><a href="${pageContext.request.contextPath}/meeting/admin">管理员</a></li>
	...
	<!-- <div class="feature-focus" id="feature-focus"> -->
        ...
        <form  id="upload" method="post" action="${pageContext.request.contextPath }/meeting/upload" enctype="multipart/form-data">
           <table border="1" cellpadding="15" align="center">
				<tr>
				  <td width="150px;" style="font-size: 18px;">城&nbsp;&nbsp;&nbsp;&nbsp;市</td>
				  <td width="260px;">
				 <!--  <input type="text" name="city" value="" class="Required" placeholder="请输入所在城市"> -->
				 <select style="font-size: 18px;" style="font-size: 18px;width: 90px;" name="city" required="">
																<option>合肥</option>
																<option>南京</option>
																<option>上海</option>
																<option>杭州</option>
				...
				<tr>
				  ...
				  <select style="font-size: 18px;" style="font-size: 18px;width: 90px;" name="type" required="">
																<option>会议室</option>
																<option>宴会厅</option>	
																<option>广场</option>
																<option>礼堂</option>
				...
				<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
				<tr>
				  <td style="font-size: 18px;">空闲时间</td>
				  <td><input style="font-size: 18px;" type="date" name="time" value="" class="Required" placeholder="请输入时间"></td>
				</tr>
				<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
				<tr>
				...
				<!--   <input type="text" name="money" value="" class="Required" placeholder="请输入价格"> -->
				  <select style="font-size: 18px;" style="font-size: 18px;width: 90px;" name="money" required="">
																<option>200</option>
																<option>500</option>
																<option>1500</option>
																<option>2500</option>
				...
				<tr>
				  ...
				  <select style="font-size: 18px;" style="font-size: 18px;width: 90px;" name="num" required="">
																<option>10</option>
																<option>30</option>
																<option>50</option>
																<option>80</option>
				...
				<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
				<tr>  
				 <td style="font-size: 18px;">会议室图片</td>
				 <td>   <input  type="file"  name="pic" id="pic">
				 </td>
				 </tr>
				 <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
                <tr>
				  <td style="font-size: 18px;">会议室描述</td>
				  <td><textarea style="font-size: 18px;" style="font-size: 18px;"  rows="5" id="user-intro" name="info"
																placeholder="输入备注"></textarea></td>
				</tr>
                 
        <!--  <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr> -->
           <tr> <td colspan="1" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input style="font-size: 18px;"  type="submit" value="上传">
            &nbsp;&nbsp;&nbsp;
