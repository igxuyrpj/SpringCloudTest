	...
	<div class="body">
		<div class="vli">
			<div class="wrapper move">
				<div id="register">
					<form class="form2" method="post" action="${pageContext.request.contextPath}/register">
						<h2>欢迎注册</h2>
						...
						<div class="vali">
								<input type="text" name="phone_number" value="" placeholder="请输入11位手机号" class="phone">
							</div>
						<div class="marb0">
							
						<div class="vali">
							<input type="password" name="password" value="" placeholder="请填写长度为6-20个字符的密码" class="pasw">
						</div>
						<div class="vali">
						...
						<div class="submit">
							<input type="submit" class="btn" id="btn" value="立即注册">
						</div>
						<span style="margin-left: 2px;"><a style="text-decoration: none;" href="login.jsp">点击登录</a></span>
					</form>
				</div>
			</div>
		</div>
