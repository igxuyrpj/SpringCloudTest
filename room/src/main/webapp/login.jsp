...
<body>
<div style="background-image: url('imgs/3.jpg'); width: 700px;height: 370px;margin: 0 auto;">
<form action="${pageContext.request.contextPath}/login" method="post">
	<fieldset>
		...
		<span style="font-size: 14px;"><a style="text-decoration:none;" href="register.jsp">点击注册</a></span>
	</fieldset>
</form>
</div>
<script>
