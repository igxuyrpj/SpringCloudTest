	...
	/*  console.log( $('form').serialize()); */
		...
		$.ajax({
			...
			success:function(data){
				if(data==1){
					/* alert("该用户名已被注册!") */
					 $('#checkResult').html('该学号已被注册!').css('color','red'); 
...
<body>
<div style="background-image: url('imgs/3.jpg'); width: 1200px;height: 670px;margin: 0 auto;">
<form action="${pageContext.request.contextPath}/register" method="post">
	<fieldset>
		...
		</label><span style="font-size: 14px;"><a style="text-decoration:none;" href="index.jsp">点击返回</a></span>
	</fieldset>
</form>
</div>
<script>
