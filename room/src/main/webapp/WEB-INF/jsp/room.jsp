  ...
  <div class="wp-inner clearfix">
    <div class="wp-panel main-nav-panel panel-5" frag="面板5">
      <div class="wp-window main-nav-window window-5" frag="窗口5" >
          ...
          <ul style="margin-right: 10px; width: 580px;" class="wp-menu clearfix" data-nav-aside="{&quot;title&quot;:&quot;导航&quot;,&quot;index&quot;:0}">
...
<div style="background-image: url('../imgs/3.jpg');">
<div style="font-size: 20px;margin-left: 70px;margin-bottom: 10px;"><a style="text-decoration: none;" href="${pageContext.request.contextPath}/chinaren//addRoom">添加教室</a></div>
		<c:if test="${empty requestScope.lists }">
<h3>没有找到相关信息！</h3>
</c:if>
  <c:if test="${!empty requestScope.lists }">
    <table border="1px;"  cellpadding="7" align="center" style="margin: 0 auto;text-align: center; width: 90%">
    <tr>
         ...
         ${stu.classNo }
          ...
          <td>${stu.floor }</td>
           <td>${stu.state }</td>
            <td>${stu.seat }</td>
             <td>${stu.media }</td>
             <td width="190px;">${stu.date }</td>
             
             
            <td><a href="${pageContext.request.contextPath }/chinaren/updateClass/${stu.id }">编辑</a></td>
             <td><a href="${pageContext.request.contextPath }/chinaren/deleteClass/${stu.id }" onclick="return del()">删除</a></td>
