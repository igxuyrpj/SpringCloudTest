...
<div style="margin-left: 20px;margin-top: -11px;background-image:url('../images/11.jpg');">
   <form action="${pageContext.request.contextPath }/chinaren/insertMyRoom1" method="post">
	<table border="1" width="375px" height="400px" style="text-align: center;margin-left: 480px;font-size: 32px;">
			<tr>
				...
				<%-- <td><label>${emp.id}  </label></td> --%>
				 <td><input style="height:25px;text-align: center;  " id="id" type="text" name="id" value="${lists.id }"></td> 
			</tr>
			<tr>
				<td style="font-weight:bolder;" width="80px;">学号</td>
				<%--<td><label>${emp.num }  </label></td>--%>
				 <td><input style="height:25px;text-align: center;  " id="id" type="text" name="num" value="${lists.num }"></td> 
			</tr>
			<tr>
				<td style="font-weight:bolder;">用户姓名</td>
				<%-- <td><label>${emp.name}  </label></td>--%>
				<td><input  style="height:25px;text-align: center;  "  id="name"  type="text" name="stuName" value="${lists.stuName}"></td> 
			</tr>
			 
			<tr>
				<td style="font-weight:bolder;"> 教学楼</td>
				<%-- <td><label>${emp.major}</label></td>--%>
				<td><input  style="height:25px;text-align: center;  "  id="userpassword"  type="text" name="className" value="${lists.className}"></td> 
			</tr>
			<tr>
				<td style="font-weight:bolder;"> 楼层</td>
				<%--<td><label>${emp.college}</label></td> --%>
				 <td><input  style="height:25px;text-align: center;  "  id="userpassword"  type="text" name="floor" value="${lists.floor}"></td>
			</tr>
			<tr>
				<td style="font-weight:bolder;">班级号码</td>
				<%-- <td><label>${emp.class1}</label></td> --%>
				<td><input  style="height:25px; text-align: center; "  id="userpassword"  type="text" name="classNo" value="${lists.classNo}"></td>
			</tr>
			<tr>
				<td style="font-weight:bolder;">日期</td>
			 <td><input style="height: 40px;" type="date" name="date" value="2018-06-01"></td>
	</tr>
				<!--主体开始-->

          <tr>
				<td style="font-weight:bolder;">时间</td>
              <td> <input style="height: 40px;width:132px; " type="text" name="datepicker" id="datetimepicker1" class="form-control" value="9:00"/>
              </td>
              </tr>
				...
				<td colspan="2">
					...
					<button onclick="return del()" style="width: 64px;height: 30px;" ><a href="${pageContext.request.contextPath }/chinaren/Creservation">取消预约</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
