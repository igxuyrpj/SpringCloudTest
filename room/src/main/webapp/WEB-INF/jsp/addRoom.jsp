          ...
          <ul style="margin-right: 40px; width: 552px;" class="wp-menu clearfix" data-nav-aside="{&quot;title&quot;:&quot;导航&quot;,&quot;index&quot;:0}">
            ...
            <li class="menu-item i1"><a class="menu-link" href="${pageContext.request.contextPath}/chinaren/Creservation" target="_self">教室预约</a> 
             ...
             <li class="menu-item i1"><a class="menu-link" href="${pageContext.request.contextPath}/chinaren/personal" target="_self">个人中心</a> 
              ...
              <li class="menu-item i1"><a class="menu-link" href="${pageContext.request.contextPath}/chinaren/alogin" target="_blank">管理员</a> 
...
<div style="margin-left: 400px;margin-top: 20px;text-align: center;">
   <form action="${pageContext.request.contextPath }/chinaren/addSaveRoom1" method="post">
	<table border="1" width="375px" height="400px" >
			<tr>
				<td width="80px;">教学楼</td>
				<td >
				   <select style="width:180px;height:40px; text-align: center; " name="className",id="className">
				   <option>慎思楼</option>
				   <option>博学楼</option>
				   <option>明德楼</option>
				   <option>行知楼</option>
				...
				<td>楼层</td>
				<td >
				   <select style="width:180px;height:40px; text-align: center; " name="floor" id="floor">
				   <option>一楼</option>
				   <option>二楼</option>
				   <option>三楼</option>
				   <option>四楼</option>
			...
			<tr>
			 ...
			 <td><input style="height:40px;width:180px;text-align: center; " id="classNo" type="text" name="classNo" value=""></td> 
			</tr>
			
				<td> 状态</td>
				<td >
				   <select style="width:180px;height:40px; text-align: center; " name="state",id="state">
				   <option>空闲</option>
				   <option>已预约</option>
			...
			<tr>
				<td> 座位数</td>
				<td >
				   <select style="width:180px;height:40px; text-align: center; " name="seat",id="seat">
				   <option>30</option>
				   <option>40</option>
				   <option>50</option>
				   <option>60</option>
			...
			<tr>
				<td>多媒体</td>
				<td >
				   <select style="width:180px;height:40px; text-align: center; " name="media",id="media">
				   <option>有</option>
				   <option>无</option>			   
				   </select>				
				</td>
				...
				&nbsp;&nbsp;
					...
					<input style="width: 64px;height: 30px;" id="butt" onclick="return check()"  type="submit" value="确定">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input style="width: 64px;height: 30px;" type="button"  onclick="javascript:window.history.back(-1);"   value="返回">
				</td>
