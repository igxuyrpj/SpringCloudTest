...
<div style="background-image: url('../imgs/3.jpg');height:500px;">
         ...
         ${stu.num }
          ...
          <td>${stu.stuName }</td>
           <td>${stu.classNo }</td>
            <td>${stu.floor }</td>
             <td>${stu.date }</td>
            <td>${stu.datepicker }</td>
            
             
             
            <td><a href="${pageContext.request.contextPath }/chinaren/updateRooms/${stu.id }">编辑</a></td>
             <td><a href="${pageContext.request.contextPath }/chinaren/deleteRooms/${stu.id }" onclick="return del()">删除</a></td>
