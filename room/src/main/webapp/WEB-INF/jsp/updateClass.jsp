...
<div style="margin-left: 400px;margin-top: 20px;text-align: center;">
   <form action="${pageContext.request.contextPath }/chinaren/updateSaveClass" method="post">
	...
	<tr>
			...
			<tr>
				...
				<%-- <td><label>${emp.major}</label></td> --%>
				 <td><input  style="height:20px;text-align: center; "  id="major"  type="text" name="state" value="${emp.state}"></td> 
			</tr>
			<tr>
				<td> 座位数</td>
				<%-- <td><label>${emp.college}</label></td> --%>
			<td><input  style="height:20px;text-align: center; "  id="college"  type="text" name="seat" value="${emp.seat}"></td> 
			</tr>
			<tr>
				<td>多媒体</td>
