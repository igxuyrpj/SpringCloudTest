    ...
    <div class="wp-panel main-nav-panel panel-5" frag="面板5">
      <div class="wp-window main-nav-window window-5" frag="窗口5" >
          ...
          <ul style="margin-right: 40px; width: 580px;" class="wp-menu clearfix" data-nav-aside="{&quot;title&quot;:&quot;导航&quot;,&quot;index&quot;:0}">
            ...
            <%--  <li class="menu-item i1"><a class="menu-link" href="${pageContext.request.contextPath}/chinaren/myRoom" target="_self">已预约</a> 
...
<div>
<div style="margin-left: 400px;margin-top: 20px;text-align: center;">
   <form action="${pageContext.request.contextPath }/chinaren/updateSaveRoom1" method="post">
	<table border="1" width="375px" height="400px" >
	<tr>
				<td width="80px;" height="25px;">id(不可编辑)</td>
				<%-- <td><label name="id" >${emp.id}  </label></td>--%>
				<td><input style="height:20px;text-align: center; " id="id" type="text" name="id" value="${emp.id }"></td> 
			</tr>
			<tr>
				<td width="80px;">教学楼</td>
				<%-- <td><label>${emp.school}  </label></td> --%>
			<td><input style="height:20px;text-align: center; " id="school" type="text" name="className" value="${emp.className }"></td> 
			</tr>
			<tr>
				<td width="80px;">班级编号</td>
				<%-- <td><label>${emp.num }  </label></td> --%>
			 <td><input style="height:20px;text-align: center; " id="num" type="text" name="classNo" value="${emp.classNo }"></td> 
			</tr>
			<tr>
				<td>楼层</td>
				<%-- <td><label>${emp.name}  </label></td> --%>
			<td><input  style="height:20px;text-align: center; "  id="name"  type="text" name="floor" value="${emp.floor}"></td> 
			</tr>
			 
			<tr>
				<td> 学号</td>
				<%-- <td><label>${emp.major}</label></td> --%>
				 <td><input  style="height:20px;text-align: center; "  id="major"  type="text" name="num" value="${emp.num}"></td> 
			</tr>
			<tr>
				<td> 姓名</td>
				<%-- <td><label>${emp.college}</label></td> --%>
			<td><input  style="height:20px;text-align: center; "  id="college"  type="text" name="stuName" value="${emp.stuName}"></td> 
			</tr>
			<%-- <tr>
				<td>多媒体</td>
				<td><label>${emp.class1}</label></td>
			<td><input  style="height:20px;text-align: center; "  id="class1"  type="text" name="media" value="${emp.media}"></td> 
			</tr> --%>
