          ...
          <ul style="margin-right: 40px; width: 552px;" class="wp-menu clearfix" data-nav-aside="{&quot;title&quot;:&quot;导航&quot;,&quot;index&quot;:0}">
            ...
            <li class="menu-item i1"><a class="menu-link" href="${pageContext.request.contextPath}/chinaren/Creservation" target="_self">教室预约</a> 
             ...
             <li class="menu-item i1"><a class="menu-link" href="${pageContext.request.contextPath}/chinaren/personal" target="_self">个人中心</a> 
              ...
              <li class="menu-item i1"><a class="menu-link" href="${pageContext.request.contextPath}/chinaren/alogin" target="_self">管理员</a> 
...
<div style="margin-left: 20px;margin-top: -11px;background-image:url('../images/11.jpg');">
   <form action="${pageContext.request.contextPath }/chinaren/index" method="post">
	<table border="1" width="375px" height="400px" style="text-align: center;margin-left: 480px;font-size: 32px;">
			<tr>
				<td style="font-weight:bolder;" width="80px;">编号</td>
				<%-- <td><label>${emp.id}  </label></td> --%>
				 <td><input style="height:25px;text-align: center;  " id="id" type="text" name="id" value="${emp.id }"></td> 
			</tr>
			<tr>
				<td style="font-weight:bolder;" width="80px;">学号</td>
				<%--<td><label>${emp.num }  </label></td>--%>
				 <td><input style="height:25px;text-align: center;  " id="id" type="text" name="num" value="${emp.num }"></td> 
			</tr>
			<tr>
				<td style="font-weight:bolder;">用户姓名</td>
				<%-- <td><label>${emp.name}  </label></td>--%>
				<td><input  style="height:25px;text-align: center;  "  id="name"  type="text" name="name" value="${emp.name}"></td> 
			</tr>
			 
			<tr>
				<td style="font-weight:bolder;"> 专业</td>
				<%-- <td><label>${emp.major}</label></td>--%>
				<td><input  style="height:25px;text-align: center;  "  id="userpassword"  type="text" name="major" value="${emp.major}"></td> 
			</tr>
			<tr>
				<td style="font-weight:bolder;"> 系别</td>
				<%--<td><label>${emp.college}</label></td> --%>
				 <td><input  style="height:25px;text-align: center;  "  id="userpassword"  type="text" name="college" value="${emp.college}"></td>
			</tr>
			<tr>
				<td style="font-weight:bolder;">班级</td>
				<%-- <td><label>${emp.class1}</label></td> --%>
				<td><input  style="height:25px; text-align: center; "  id="userpassword"  type="text" name="class1" value="${emp.class1}"></td>
			</tr>
			<tr>
				<td style="font-weight:bolder;"> 联系方式</td>
				<%-- <td><label>${emp.phone}</label></td>--%>
				<td><input  style="height:25px; text-align: center; "  id="userpassword"  type="text" name="phone" value="${emp.phone}"></td> 
			</tr>
			<tr>
				<td style="font-weight:bolder;">年龄</td>
				<%-- <td><label>${emp.age}</label></td> --%>
				<td><input  style="height:25px;text-align: center;  "  id="userpassword"  type="text" name="age" value="${emp.age}"></td>
			</tr>
			<tr>
				<td style="font-weight:bolder;">性别</td>
				<%--<td><label>${emp.sex}</label></td>--%>
				 <td><input  style="height:25px;text-align: center;  "  id="userpassword"  type="text" name="sex" value="${emp.sex}"></td> 
			</tr>
			<%-- <tr>
				<td>入学时间</td>
