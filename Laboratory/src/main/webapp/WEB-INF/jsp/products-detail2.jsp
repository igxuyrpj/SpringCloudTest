				...
				<div class="col-md-12 serli">
					...
					<div class="pro-detail row">
						...
						<div class="col-sm-8 col-xs-12">
							...
							<table>
								<tr>
									<td class="de-feature"> 1.我校现有生物实验室1个，面积48m2，实验室的水电到位，完全满足实验仪器的存放、保管和实验准备之用。
									2. 保管室1个，面积48m2。实验操作台按照标准一类学校配备，共配座位 48个。完全满足全校学生12个分组实验的需求。 3．各种教学仪器（药品）配备品种、数量达标情况： 品种达431种，数量有5431件，价值达130586元。其中2013年新增2495种，新增部分的价值为62107元，完全能满足生物学科演示和分组实验需求。仪器按使用范围分为：
									通用、测量、专用、模型、标本、挂图、玻璃仪器、药品及其他试验材料和工具。 二、实验室、仪器室管理情况： 1、专人管理。所有仪器完好，保证紧密配合教学工作。服务教学一线，结合新课程要求，开足开齐演示实验、学生实验和探究性实验，无论分组实验还是演示实验，只要能做的，都让学生观察和实际操作。 2、制度化管理：有完善的管理规章制度，
									建有仪器借还、实验预约登记、仪器损坏报废登记等制度，各实验室、仪器室有相应的使用规则，实验室工作以教学为中心，以提高教学质量为目的，加强实验教学环节。并积极创造条件向学生开放实验室，在教师和实验人员的指导下开展课外科技活动。 3、明细化管理：仪器室的仪器建有总帐、分类帐，各室建有明细帐，并做到柜有柜卡，物有标签，仪器存放整齐、
									规范，对部分仪器定期维修，保证正常使用，坚持做到期初有计划、期末有总结，各项制度、实验员工作职责都张贴在墙上，以便经常对照学习。</td>
