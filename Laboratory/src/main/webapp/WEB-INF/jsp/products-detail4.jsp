				...
				<div class="col-md-12 serli">
					...
					<div class="pro-detail row">
						...
						<div class="col-sm-8 col-xs-12">
							...
							<table>
								<tr>
									<td class="de-feature">电机与拖动实验室建于2007年，主要服务于电气工程及其自动化和自动化两个专业，目前主要面向的课程有：《电机学》和《电机与拖动》两门专业课。实验室拥有DDSZ-1型电机及电气技术实验装置10套和各种类型电动机及测量仪器。
本装置可以完成如下实验：直流发电机特性实验；直流电动机和三相异步电动机的参数测定、起动、调速及制动等实验；同步发电机参数测定及运行特性实验；单相变压器和三项变压器参数测定及运行特性实验；基于继电接触控制的电机控制类实验等实验项目。
通过本实验装置的训练，有利于学生对变压器、发电机、电动机等相关知识的巩固与实践，同时电机控制实验可以使学生掌握如何使用各种电机完成相应的功能。</td>
