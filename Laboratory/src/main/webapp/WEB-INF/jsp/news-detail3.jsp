			...
			<div class="row">
				...
				<div class="col-md-12 serli">
					...
					<div class="news-deatil">
						<h2>国内首个风电制氢工业应用项目制氢站开工</h2>
						<p class="news-time">
							发布时间：2017-6-22
						</p>
						<img src="../static/images/news/news4.jpg"/>
						<div class="news-con">
							<p>
					...
					<ul class="pager">
					    <li class="previous"><a href="news-detail2.html"><span aria-hidden="true"></span> 上一篇：中国成功研制分辨多功能化学成像系统</a></li>
					    <li class="next"><a href="#">下一篇：没有了 <span aria-hidden="true"></span></a></li>
				    </ul>
				</div>
			</div>
		</div>
