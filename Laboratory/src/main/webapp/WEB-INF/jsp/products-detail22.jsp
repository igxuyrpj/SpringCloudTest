			...
			<div class="">
				...
				<div class="col-md-12 serli">
					<ol class="breadcrumb">
						...
						<li class="active">生物实验室</li>
					</ol>
					
					<div class="pro-detail row">
						<div class="col-sm-4 col-xs-12 ">
						<img src="../img/9.jpg" width="350px;"height="200px;"/>
							<img src="../img/10.jpg" width="350px;"height="200px;"/>
							<img src="../img/11.jpg" width="350px;"height="200px;"/>
							<img src="../img/12.jpg" width="350px;"height="200px;"/>
							<table class="price">
						...
						<div class="col-sm-8 col-xs-12">
							...
							<table>
								<tr>
									<td class="de-feature"> <h2>项目名称：汽车丢失登记与查询</h2><br><br>
荣誉：一等奖<br><br>
设计者：宋瑞娟、蒋治国<br><br>
指导老师：方周<br><br>
项目概述：本设计是一款有关汽车的失物招领的APP，包括用户登录模块、发布汽车丢失信息模块以及上传车辆追踪模块等。失主在该平台上发布丢车信息，还可以实时更新查找有关信息。通过移动互联网的帮助，人们可以高效的寻找到自己的车。</td>
