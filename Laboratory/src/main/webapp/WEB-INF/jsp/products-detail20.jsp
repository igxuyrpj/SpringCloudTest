				...
				<div class="col-md-12 serli">
					...
					<div class="pro-detail row">
						<div class="col-sm-4 col-xs-12 ">
							<img src="../img/1.jpg" width="350px;"height="200px;"/>
							<img src="../img/2.jpg" width="350px;"height="200px;"/>
							<img src="../img/3.jpg" width="350px;"height="200px;"/>
							<img src="../img/4.jpg" width="350px;"height="200px;"/>
							<table class="price">
...
指导老师：方周</br>
设计者：赵亚、许明 </br>
   项目概述：“宠物商城”着力打造公益平台，努力帮助每一位爱宠之士，用户通过手机号、微信、QQ、微博等方式注册成为会员。通过该平台可以获得更多关于宠物的信息，同时还可以捐赠物资和领养宠物。这样，不仅有助于美化和谐社会，还可以促进人与动物的感情。</td>
